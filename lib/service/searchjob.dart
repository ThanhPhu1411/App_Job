...
class searchjob{
  final String baseUrl = 'https://10.0.2.2:7044/api/SearchAPI/search';

  Future<Map<String, dynamic>?> fetchJobs({int page =1, int pageSize = 5,String? keyword, String? location, String? category,}) async {
