...
import 'package:webtimvieclam/page/ChatPage%20.dart';
import 'package:webtimvieclam/page/JobDetailPage.dart';
import '../page/MyJobpage.dart';
  ...
  Future<void> loadData() async {
    ...
    if (jobData != null) {
      setState(() {
        ...
        jobs = jobData['jobs']; // LẤY DANH SÁCH CÔNG VIỆC TỪ API
        if (savedData != null && savedData['savedJobs'] != null) {
          ...
          likedJobs = savedList
              .map<String>((j) => j['jobId'] as String)
              .toSet();
        ...
        // blogs = blogData['BlogPosts'] ?? blogData['BlogPosts'];
        isLoading = false;
      });
    }
  }
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (conext) => NotificationPage(),
                                ),
                              );
